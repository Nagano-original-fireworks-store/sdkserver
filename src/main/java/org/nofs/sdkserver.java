...
//        getLogger().info(Language.translate("messages.status.version", BuildConfig.VERSION, BuildConfig.GIT_HASH));
        ...
        httpServer.addRouter((Class<? extends Router>) RegionHandler.class, new Object[0]);
        httpServer.addRouter((Class<? extends Router>) LogHandler.class, new Object[0]);
        httpServer.addRouter((Class<? extends Router>) GenericHandler.class, new Object[0]);
        httpServer.addRouter((Class<? extends Router>) AnnouncementsHandler.class, new Object[0]);
