...
/* loaded from: sdkserver.jar:emu/grasscutter/utils/Utils.class */
public final class Utils {
    ...
    public static boolean copyFromResources(String resource, String destination) {
        try {
            InputStream stream = Grasscutter.class.getResourceAsStream(resource);
            if (stream == null) {
            ...
            Grasscutter.getLogger().warn("Unable to copy resource " + resource + " to " + destination, (Throwable) exception);
            return false;
        }
    }
