...
/* loaded from: org.nofs.jar:emu/grasscutter/server/http/objects/LoginResultJson.class */
public class LoginResultJson {
    public String message;
    public int retcode;
    public VerifyData data = new VerifyData();

    /* loaded from: org.nofs.jar:emu/grasscutter/server/http/objects/LoginResultJson$VerifyAccountData.class */
    ...
    /* loaded from: org.nofs.jar:emu/grasscutter/server/http/objects/LoginResultJson$VerifyData.class */
