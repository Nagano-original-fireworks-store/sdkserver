...
/* loaded from: org.nofs.jar:emu/grasscutter/server/http/objects/ComboTokenResJson.class */
public class ComboTokenResJson {
    public String message;
    public int retcode;
    public LoginData data = new LoginData();

    /* loaded from: org.nofs.jar:emu/grasscutter/server/http/objects/ComboTokenResJson$LoginData.class */
