...
/* loaded from: sdkserver.jar:emu/grasscutter/server/http/handlers/GenericHandler.class */
public final class GenericHandler implements Router {
    ...
    public void applyRoutes(Javalin javalin) {
        ...
        allRoutes(javalin, "/hk4e_global/combo/granter/api/compareProtocolVersion", new HttpJsonResponse("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"modified\":true,\"protocol\":{\"id\":0,\"app_id\":4,\"language\":\"en\",\"user_proto\":\"\",\"priv_proto\":\"\",\"major\":7,\"minimum\":0,\"create_time\":\"0\",\"teenager_proto\":\"\",\"third_proto\":\"\"}}}"));
        ...
        allRoutes(javalin, "/log/sdk/upload", new HttpJsonResponse("{\"code\":0}"));
    ...
    private static void serverStatus(Context ctx) {
        int maxPlayer = Configuration.ACCOUNT.maxPlayer;
        String version = GameConstants.VERSION;
        ctx.result("{\"retcode\":0,\"status\":{\"playerCount\":0,\"maxPlayer\":" + maxPlayer + ",\"version\":\"" + version + "\"}}");
    }
}
