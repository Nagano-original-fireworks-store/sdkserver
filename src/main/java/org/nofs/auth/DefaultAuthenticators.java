...
/* loaded from: org.nofs.jar:emu/sdkserver/auth/DefaultAuthenticators.class */
public final class DefaultAuthenticators {

    /* loaded from: org.nofs.jar:emu/sdkserver/auth/DefaultAuthenticators$PasswordAuthenticator.class */
    public static class PasswordAuthenticator implements Authenticator<LoginResultJson> {
        ...
        @Override // org.nofs.auth.Authenticator
            ...
            if ($assertionsDisabled || requestData != null) {
                ...
                if (account == null && Configuration.ACCOUNT.autoCreate) {
                    ...
                    if (account == null) {
                        ...
                        sdkserver.getLogger().info(Language.translate("messages.dispatch.account.account_login_create_error", address));
                    } else {
                        successfulLogin = true;
                        sdkserver.getLogger().info(Language.translate("messages.dispatch.account.account_login_create_success", address, response.data.account.uid));
                    }
                ...
                sdkserver.getLogger().info(loggerMessage);
                return response;
            }
    ...
    /* loaded from: org.nofs.jar:emu/sdkserver/auth/DefaultAuthenticators$ExperimentalPasswordAuthenticator.class */
    ...
    /* loaded from: org.nofs.jar:emu/sdkserver/auth/DefaultAuthenticators$TokenAuthenticator.class */
    public static class TokenAuthenticator implements Authenticator<LoginResultJson> {
        ...
        public LoginResultJson authenticate(AuthenticationSystem.AuthenticationRequest request) {
            ...
            if ($assertionsDisabled || requestData != null) {
                String address = request.getContext().ip();
                sdkserver.getLogger().info(Language.translate("messages.dispatch.account.login_token_attempt", address));
    ...
    /* loaded from: org.nofs.jar:emu/sdkserver/auth/DefaultAuthenticators$SessionKeyAuthenticator.class */
    ...
    /* loaded from: org.nofs.jar:emu/sdkserver/auth/DefaultAuthenticators$ExternalAuthentication.class */
    public static class ExternalAuthentication implements ExternalAuthenticator {
        @Override // org.nofs.auth.ExternalAuthenticator
    ...
    /* loaded from: org.nofs.jar:emu/sdkserver/auth/DefaultAuthenticators$OAuthAuthentication.class */
    public static class OAuthAuthentication implements OAuthAuthenticator {
        @Override // org.nofs.auth.OAuthAuthenticator
        public void handleLogin(AuthenticationSystem.AuthenticationRequest request) {
            request.getContext().result("Authentication is not available with the default authentication method.");
        }
